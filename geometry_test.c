...
/* coord_2d triangle test Suite */
Suite* coord_area_suite(void)
{

    /* Create Suite */
    Suite* s = suite_create("coord_area");

    /* Setup Test Cases */
    TCase* tc_area = tcase_create("coord_area_test_1");
    tcase_add_test(tc_area, test_area);
